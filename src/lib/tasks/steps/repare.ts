...
export default () => [
   ...
   'apt-get install -f -y',
   'apt-get install apt-utils coreutils sysvinit-utils systemd systemd-sysv software-properties-common build-essential gcc g++ make dialog zip gzip tar unzip acl curl wget --no-install-recommends --no-install-suggests ssh -y',
